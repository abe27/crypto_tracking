...
class exchange_list(models.Model):
    ...
    exchange_transfer_fee = fields.Monetary(string="Exchange Transfer", default=0.0, tracking=True)
...
class block_chain_network(models.Model):
    ...
    description = fields.Text(string="Description", tracking=True)
    fee = fields.Float(string="Fee", digits=(12,8),default="0.00", tracking=True)
    is_active = fields.Boolean(string="Is Active", default=False, tracking=True)
...
class transfer_fee(models.Model):
    ...
    name = fields.Char(string="Symbol Description", compute="_value_symbol", store=True, tracking=True)
    ...
    fee = fields.Float(string="Fee", digits=(12,8), default="0.0", tracking=True)
    block_summary = fields.Float(string="จํานวน Block ที่ต้องรอ", digits=(12,2),default="0.0", tracking=True)
    is_active = fields.Boolean(string="Is Active", default=False, tracking=True)
...
class crypto_tracking(models.Model):
    ...
    percentChange = fields.Float(string="percentChange", digits=(12,8), default="0.0", tracking=True)# "percentChange": 0.3,
    baseVolume = fields.Float(string="baseVolume", digits=(12,8), default="0.0", tracking=True)# "baseVolume": 50.62163798,
    quoteVolume = fields.Float(string="quoteVolume", digits=(12,8), default="0.0", tracking=True)# "quoteVolume": 46120153.06,
    isFrozen = fields.Float(string="isFrozen", digits=(12,8), default="0.0", tracking=True)# "isFrozen": 0,
    high24hr = fields.Float(string="high24hr", digits=(12,8), default="0.0", tracking=True)# "high24hr": 920606.38,
    low24hr = fields.Float(string="low24hr", digits=(12,8), default="0.0", tracking=True)# "low24hr": 900200,
